  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form action="srvUsuario" method="POST" id="formUsuario" enctype="multipart/form-data">
        ...
        <!-- SECCIÓN ESTÁTICA: Información Básica -->
        <div class="box box-primary">
          <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-id-card"></i> Información Básica</h3>
          </div>
          <div class="box-body">
            <div class="row">
              <div class="col-md-7">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="nombres" class="form-control" 
                             ...
                             required maxlength="128" placeholder="Ej: Administrador">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="apellidos" class="form-control" 
                             ...
                             required maxlength="128" placeholder="Ej: del Sistema">
                    </div>
                  </div>
                  <div class="col-md-12">
                    <div class="form-group">
              ...
              <div class="col-md-5">
                <div class="form-group" style="margin-bottom: 8px;">
                  <label style="display: block;"><i class="fa fa-camera"></i> Foto de Perfil</label>
                  <div id="previewWrapper" style="border: 1px dashed #00c0ef; border-radius: 8px; padding: 10px; text-align: center; min-height: 200px; display: flex; align-items: center; justify-content: center; background: #f7fdff;">
                    <span id="previewPlaceholder" style="color: #7a7a7a;">Sin imagen</span>
                  ...
                  <div style="margin-top: 8px;">
                    ...
                    <small class="text-muted">JPG/PNG/WEBP · máx. 2 MB</small>
                  </div>
                </div>
              </div>
            </div>
            <div class="alert alert-info" style="border-left: 4px solid #3c8dbc; margin-bottom: 0;">
              <i class="fa fa-info-circle"></i> <strong>Nota:</strong> Complete los datos básicos del usuario. Los campos marcados con <span class="text-danger">*</span> son obligatorios.
            </div>
          </div>
        </div>

        <!-- TABS: Datos Personales, Contacto, Usuario, Confirmación -->
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#tab-personal" data-toggle="tab"><i class="fa fa-user"></i> Datos Personales</a></li>
            <li><a href="#tab-contacto" data-toggle="tab"><i class="fa fa-phone"></i> Contacto</a></li>
            <li><a href="#tab-usuario" data-toggle="tab"><i class="fa fa-key"></i> Usuario</a></li>
            <li><a href="#tab-confirmacion" data-toggle="tab"><i class="fa fa-check-circle"></i> Confirmación</a></li>
          </ul>
          <div class="tab-content" style="padding-top: 15px;">
            ...
            <div class="tab-pane active" id="tab-personal">
              ...
              <div class="box-footer text-right">
                <button type="button" class="btn btn-primary btn-lg btn-next" data-next="tab-contacto">
            ...
            <!-- TAB 2: Contacto -->
            <div class="tab-pane" id="tab-contacto">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-phone"></i> Información de Contacto</h3>
                </div>
                <div class="box-body">
                  <c:if test="${accion == 'crear'}">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="telefono" class="form-control" maxlength="10" 
                                 pattern="[0-9]{10}" placeholder="Ej: 0987654321">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <button type="button" class="btn btn-primary btn-lg btn-next pull-right" data-next="tab-usuario">
                  Siguiente <i class="fa fa-arrow-right"></i>
                </button>
              </div>
            </div>
            ...
            <div class="tab-pane" id="tab-usuario">
              ...
              <!-- Botones de navegación -->
              <div class="box-footer">
                <button type="button" class="btn btn-default btn-lg btn-prev" data-prev="tab-contacto">
                  <i class="fa fa-arrow-left"></i> Anterior
                </button>
                <button type="button" class="btn btn-primary btn-lg btn-next pull-right" data-next="tab-confirmacion">
                  Siguiente <i class="fa fa-arrow-right"></i>
                </button>
              </div>
            </div>

            <!-- TAB 4: Confirmación (Perfiles y Permisos) -->
            <div class="tab-pane" id="tab-confirmacion">
              ...
              <!-- Botones de navegación -->
              <div class="box-footer">
                <button type="button" class="btn btn-default btn-lg btn-prev" data-prev="tab-usuario">
                  <i class="fa fa-arrow-left"></i> Anterior
                </button>
                <div class="pull-right">
